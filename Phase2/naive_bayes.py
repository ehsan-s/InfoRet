...
class NaiveBayesClassifier:
    ...
    def __init__(self, raw_train_docs, train_tags, preprocessor):
        ...
        train_docs = self.preprocessor.preprocess(raw_train_docs)
        self.__preprocess_training_set(train_docs, train_tags)
...
if __name__ == '__main__':
    ...
    naive_bayes_classifier = NaiveBayesClassifier(train_data[0], test_data[1], Preprocessor())
